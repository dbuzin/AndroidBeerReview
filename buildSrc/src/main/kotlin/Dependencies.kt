object Dependencies {
    ...
    const val androidCoreKtx = "androidx.core:core-ktx:${Versions.androidCore}"
    const val appCompat = "androidx.appcompat:appcompat:${Versions.appCompat}"
    const val activityCompose = "androidx.activity:activity-compose:${Versions.activityCompose}"

    const val barcodeScanning = "com.google.mlkit:barcode-scanning:${Versions.barcodeScan}"

    const val composeMaterial = "androidx.compose.material:material:${Versions.compose}"
    const val composeTooling = "androidx.compose.ui:ui-tooling:${Versions.compose}"

    const val cryptoAndroid = "androidx.security:security-crypto:${Versions.cryptoAndroid}"
    ...
    const val cameraView = "androidx.camera:camera-view:${Versions.cameraBeta}"
    const val cameraExtensions = "androidx.camera:camera-extensions:${Versions.cameraBeta}"
